...
def main():
    ...
    probe, clean_accuracy = train_linear_probe(encoder, eval_train_loader, eval_test_loader)
    ...
    print(f"Sample Image - True Label: {sample_label}, Predicted: {predicted_class}, Confidence: {confidence:.4f}")
    
    # Compute Integrated Gradients
    print("Computing Integrated Gradients...")
    attribution = integrated_gradients(probe, sample_image, predicted_class, steps=50)
    
    # Visualize
    visualize_attribution(sample_image, attribution, save_path='attribution_heatmap.png')
